...
function DockItem({
    ...
    return (
      ...
      bg-white dark:bg-neutral-800 shadow-md cursor-pointer transition-colors"
            tabIndex={0}
            role="button"
            aria-haspopup="true"
        >
            ...
            border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#060606] 
            px-2 py-0.5 text-xs text-neutral-900 dark:text-white"
                        style={{ x: "-50%" }}
                        role="tooltip"
                    >
                        {label}
